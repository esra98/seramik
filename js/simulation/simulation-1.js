var colorChosen = "M3"
var colorsUsed = {}
var chosenPattern = "canvas1"
//seçilen tile categoryi değiştirmek için:
document.getElementById("square").addEventListener("click", function()
{ 
    document.getElementById("square").classList.add("chosenCategory")
    document.getElementById("hexa").classList.remove("chosenCategory")
    document.getElementById("patternsSquare").classList.remove("hidden")
    document.getElementById("patternsHexa").classList.add("hidden")
});
document.getElementById("hexa").addEventListener("click", function()
{ 
    document.getElementById("hexa").classList.add("chosenCategory")
    document.getElementById("square").classList.remove("chosenCategory")
    document.getElementById("patternsHexa").classList.remove("hidden")
    document.getElementById("patternsSquare").classList.add("hidden")
});
